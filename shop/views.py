...
def product_list(request, category_slug=None):
    ...
    if request.GET:
        productfilter = ProductFilter(request.GET)
        products = ProductFilter(request.GET).qs ## Query_set
    else:
         productfilter = ProductFilter()
    ...
    context = {'category': category, 'categories': categories, 'products': products ,'productfilter':productfilter}
